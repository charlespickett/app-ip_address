 ...
 * @return {string} (firstIpAddress) - An object with an IPv4 address and an IPv6 address converted from the passed IPv4 as properties
 */
...
class IpAddress {
  ...
  if (!cidr.isValid()) {
    ...
    [firstIpAddress['IPV4'], firstIpAddress['IPV6']] = cidr.toArray(options); 
